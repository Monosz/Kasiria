package com.example.kasiria.async;
        ...
        switch (result.getPrinterStatus()) {
            case AsyncEscPosPrint.FINISH_SUCCESS:
                new AlertDialog.Builder(context)
                        .setTitle("Berhasil")
                        .setMessage("Struk telah berhasil di print")
                        .show();
                break;
            case AsyncEscPosPrint.FINISH_NO_PRINTER:
                new AlertDialog.Builder(context)
                        .setTitle("Tidak ada printer")
                        .setMessage("Aplikasi tidak dapat menemukan printer yang terhubung.")
                        .show();
                break;
            case AsyncEscPosPrint.FINISH_PRINTER_DISCONNECTED:
                new AlertDialog.Builder(context)
                    .setTitle("Koneksi terputus")
                    .setMessage("Tidak dapat menghubungkan ke printer.")
                    .show();
                break;
